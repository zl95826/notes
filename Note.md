...
setInterval method is very similar to setTimeout, but setTimeout happens only one (time); setInterval will keep executing a piece of code at a given interval, it doesn't stop until you make a stop.
