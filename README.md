...
however if just {a}.a, it shows a syntax error, fix it by ({a}).a\
  The Object.create(proto, propertiesObject) method creates a new object, using an existing object as the prototype of the newly created object.https://hackernoon.com/object-create-in-javascript-fa8674df6ed2 \
